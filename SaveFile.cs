...
{
    //TODO: Add countermeasures for if the file does not exist
    // Add paths to read / create global variables
    ...
    public void Write(string filename, string section, string key, string value)
    {
